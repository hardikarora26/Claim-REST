...
public class MitchellClaimType {
    ...
    public void setStatus(StatusCode value) {
        this.status = value;
        System.out.println("statuscode is: "+this.status);
    }
    ...
    //	java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
     //   String convertedLossDate = sdf.format(lossDate.toGregorianCalendar().getTime()); 
  	//	 return java.sql.Timestamp.valueOf(convertedLossDate);
    	return lossDate;     
